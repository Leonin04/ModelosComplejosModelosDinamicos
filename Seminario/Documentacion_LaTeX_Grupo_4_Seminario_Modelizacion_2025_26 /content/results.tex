...
\subsection{Enfoques planteados en la literatura}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figure/Modelo_Difusion_Fit.png} 
...
La muestra incluye observaciones diarias del rendimiento del bono a 10 años de Grecia y Alemania, cubriendo el ciclo completo de la crisis de deuda soberana. La variable endógena es el spread o prima de riesgo (diferencia en puntos básicos entre el bono griego y el alemán), una medida directa de la percepción de impago por parte del mercado.

El análisis descriptivo de la variable endógena revela la magnitud extrema del fenómeno estudiado. Durante el periodo de análisis, la prima de riesgo alcanzó un valor máximo de 1987.40 puntos básicos, un nivel insostenible que refleja la ruptura del mercado de bonos. La serie presenta una media elevada y una desviación estándar significativa, con una distribución caracterizada por un exceso de curtosis (colas pesadas), lo que justifica estadísticamente el rechazo de la hipótesis de normalidad y la elección de distribuciones robustas como la t-Student para el modelado econométrico.
...
\textit{Observación}. Cuando hablamos de ``retornos reales'' nos estamos refiriendo a lo que se conoce como prima de riesgo o spread.

\subsubsection{\textbf{Diagnóstico de Convergencia Computacional}}
